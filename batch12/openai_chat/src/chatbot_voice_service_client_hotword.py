...
if __name__ == '__main__':
    ...
    voice_service_client = rospy.ServiceProxy(
         "/chatgpt_interpreter_node/voice_service",VoiceService)
    # Wait for the service to become available
    rospy.wait_for_service("/chatgpt_interpreter_node/voice_service")
    ...
    rospy.loginfo("Chatgpt Voice Service Client ready!!")
